...
pub struct App {
    ...
    #[cfg(windows)]
    pub(in crate::app) clip_prepare_rx: Option<Receiver<Vec<crate::virtual_clipboard::VirtualFile>>>,
    #[cfg(windows)]
    ...
    #[cfg(windows)]
    pub(in crate::app) watcher_rx: Option<crossbeam_channel::Receiver<notify::Result<notify::Event>>>,
    ...
    pub(in crate::app) merge_load_rx: Option<Receiver<Result<(String, Vec<crate::linemerge::Row>), String>>>,
    pub(in crate::app) merge_apply_rx: Option<Receiver<Result<(String, crate::bisync::Sig, crate::bisync::Sig), String>>>,
    ...
    pub(in crate::app) file_open_rx: Vec<(Receiver<Result<(String, i64), String>>, OpenMode, PathBuf)>,
    ...
    pub(in crate::app) agent_activate_rx: Option<Receiver<Result<(crate::agent::AgentBackend, String), String>>>,
