...
pub struct App {
    ...
    pub(in crate::app) settings: settings_ui::SettingsState,
    ...
    /// Informational scan remarks (aggregation), never a failure.
    pub(in crate::app) analytics_notes: Vec<String>,
    ...
    // ─── Share-Server persistent peer connections ───────────────────────
    ...
    pub(in crate::app) share_room_code_input: String,
    pub(in crate::app) share_room_name_input: String,
    pub(in crate::app) share_room_create_name_input: String,
    pub(in crate::app) share_room_draft_code: String,
    pub(in crate::app) share_export_scope: usize,
    pub(in crate::app) share_export_target_id: String,
