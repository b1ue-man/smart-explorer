//! Read models for the Direct requests and authorized devices screens,
//! projected from `ShareProfiles` without any UI state.
use crate::share::{
...
#[derive(Clone, Debug)]
pub struct AuthorizedDeviceView {
...
pub fn request_views(profiles: &ShareProfiles, now: i64) -> (Vec<RequestView>, Vec<RequestView>) {
...
pub fn authorized_device_views(profiles: &ShareProfiles) -> Vec<AuthorizedDeviceView> {
