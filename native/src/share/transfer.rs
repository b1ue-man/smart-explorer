...
use super::core_oslocked::{hostname, quarantine_dir, unique_in};
...
pub(crate) fn accept_loop(listener: TcpListener, session: Arc<Mutex<Session>>, answers: Answers, ev: Sender<ShareEvent>) {
...
pub(crate) fn send_to_peer(peer: &RemoteDevice, psk: &[u8; 32], paths: &[String], ev: &Sender<ShareEvent>) -> io::Result<()> {
