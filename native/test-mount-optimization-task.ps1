...
foreach ($required in @(
    ...
    'rooted_case_sensitive_stat_reuses_fresh_terminal_observation',
    'fifo_admission_drains_10000_without_overtaking',
    'metadata_progress_extends_backlog_not_transfer_deadline',
    'cancelled_waiters_preserve_fifo_and_abort_releases_queue',
    'metadata_waiter_has_priority_over_a_new_transfer',
    'transfer_gate_times_out_instead_of_starving_the_drive',
    'metadata_gate_times_out_without_service_progress',
    'metadata_priority_is_a_bounded_burst',
    'agent_reaps_completed_capacity_before_new_admission',
    'entry_table_dense_slots_survive_10000_removals',
    'entry_table_replace_and_rename_keys_across_10000_identities',
    'retirement_batches_deduplicate_10000_identities',
    'retirement_tickets_are_weak_and_last_pin_driven',
    'retirement_last_pin_reuses_clean_spool_without_double_disposal',
    'retirement_preserves_dirty_and_recovery_referenced_spools',
    'share_aggregates_match_pairwise_masks',
    'share_lifecycle_detach_rename_and_same_key',
    'handle_reservation_abort_cleanup_and_grants',
    'handle_same_identity_rename_preserves_sharing',
    'ten_thousand_same_and_unrelated_handles_drain',
    'supervisor_registers_ten_thousand_actual_leases',
    'supervisor_finish_waits_for_claim_and_never_rearms',
    'supervisor_rearm_checks_identity_stop_and_claim_failure',
    'reset_schedule_ten_thousand_rearm_and_drain',
    'reset_schedule_unlinks_and_clamps_deadlines',
    'no_follow_queries_preserve_link_and_id_boundaries',
    'unretained_observation_fences_authority_and_completes_exact_revision',
    'unchanged_parent_preserves_child_flight_and_atomically_refuses_stale_points',
    'unretained_refresh_does_not_reload_parent_for_10000_sibling_stats',
    'preload_10000_entry_cursor_survives_cancellation_without_rescan',
    'preload_old_revision_cannot_retain_or_rearm_replaced_snapshot',
    'preload_cooldown_survives_unretained_publication_and_rearms_exact_eviction',
    'daemon_fresh_unretained_image_retires_old_authority_but_errors_do_not',
    'daemon_unrelated_mutation_preserves_active_shared_flight',
    ...
    'scheduler_recent_directory_survives_old_demand_backlog',
