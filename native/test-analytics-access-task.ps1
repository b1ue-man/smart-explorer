...
foreach ($required in @(
    ...
    'treemap_origin_change_invalidates_geometry', 'invalid_startup_cannot_spawn_or_restart_a_scan',
    'first_entry_error_preserves_readable_sibling',
    'automatic_query_fallback_preserves_access_denial',
