...
g1_tests=(
  ...
  # SMB backend (smb2): URLs and shares, listing with reparse points, rename buffer, error kinds
  android_task_smb_connect_errors_keep_their_meaning
  android_task_smb_connect_failures_keep_their_protocol_kinds
  android_task_smb_directory_listing_keeps_reparse_points_as_links
  android_task_smb_directory_listing_rejects_malformed_entries
  android_task_smb_domain_user_address_and_saved_root
  android_task_smb_locations_parse_with_the_share_as_first_segment
  android_task_smb_operation_errors_map_to_io_kinds
  android_task_smb_paths_split_into_share_and_share_relative_path
  android_task_smb_protocol_and_endpoints_are_recognized
  android_task_smb_rename_information_buffer_layout
  android_task_smb_roots_dispatch_to_the_smb_backend
  ...
  android_task_exec_jobs_json_lists_incoming_first_with_snake_case_states
  android_task_exec_proc_crash_record_matches_only_the_same_process
  android_task_exec_proc_descendants_follow_setsid_children_and_orphans
  android_task_exec_proc_kill_plan_spares_the_app_hooks_and_the_intermediate
  android_task_exec_proc_stat_reads_fields_after_the_last_parenthesis
  android_task_exec_proc_stat_rejects_malformed_lines
  android_task_exec_target_keys_resolve_only_the_current_identity
  android_task_exec_targets_list_every_grant_and_member_with_state
)
android_only_tests=()
