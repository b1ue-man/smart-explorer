...
object Opener {
    ...
    fun share(context: Context, localPaths: List<String>): Outcome {
        ...
        val chooser = Intent.createChooser(send, null).apply {
            // ShareIntentHandler refuses this app's own URIs as received shares: do not offer itself.
            putExtra(Intent.EXTRA_EXCLUDE_COMPONENTS, arrayOf<Parcelable>(ComponentName(context, MainActivity::class.java)))
        }
