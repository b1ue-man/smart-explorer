...
## Summary
- 3196 nodes · 6422 edges · 217 communities (207 shown, 10 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 319 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `23846e71`
...
4. `String` - 25 edges
5. `run()` - 24 edges
6. `ShareIrohNode` - 24 edges
7. `worker()` - 24 edges
8. `SftpBackend` - 23 edges
9. `PeerBackend` - 23 edges
10. `Result` - 23 edges
...
- `prune_count_keeps_newest_n()` --calls--> `prune_versions()`  [INFERRED]
  native/src/bisync/os/shared/tests/extra.rs → native/src/bisync/os/shared/persistence.rs
...
Cohesion: 0.05
Nodes (93): archived_versions_parse_and_sort_numerically(), pin_roundtrip(), Duration, Feed, Path, PathBuf, Result, String (+85 more)

### Community 2 - "Community 2"
Cohesion: 0.08
Nodes (67): ClientMsg, Clone, CmdTx, presence_payload(), verify_hmac(), fingerprint_matches(), build_presence(), configure_updates_auth_state_synchronously() (+59 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (49): b64(), b64_decode(), eio(), hex(), hex_decode(), hex_val(), hmac_proof(), public_fingerprint() (+41 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (75): AnalyticsScan, AppErrorEntry, BisyncCtx, ClipKey, CopyHandle, CopyMode, CopyMsg, App (+67 more)

### Community 5 - "Community 5"
Cohesion: 0.06
Nodes (56): dispatch(), handle_walk_tree(), serve(), AtomicBool, Frame, Option, Read, Receiver (+48 more)
...
Cohesion: 0.14
Nodes (38): appdata_dir(), append_log(), apply_update(), ApplyArgs, arg_value(), clear_daemon_runtime_markers(), default_error_file(), find_target_processes() (+30 more)
...
Cohesion: 0.17
Nodes (30): Duration, PathBuf, Result, SocketAddr, TcpStream, clear_ipc_addr(), drain_share_worker_events(), ensure_worker_ready() (+22 more)
...
Cohesion: 0.15
Nodes (31): Option, PathBuf, String, restart_worker_for_client(), run_daemon(), autopause_flags(), autopause_path(), cadence_path() (+23 more)
...
Cohesion: 0.19
Nodes (20): Baseline, Fn, Option, Path, PathBuf, Result, app_data_dir(), Sig (+12 more)
...
Cohesion: 0.16
Nodes (12): Arc, BackendHandle, Mutex, PeerOpenTarget, ShareCmd, ShareStatus, String, default_device_name() (+4 more)
...
Cohesion: 0.15
Nodes (12): format_bytes(), format_date(), landing_time_secs(), App, SummaryData, Ui, Ui, Color32 (+4 more)
...
Cohesion: 0.31
Nodes (12): copy_fraction(), rate_text(), transfer_detail(), ui_copy_chip(), ui_progress_chip(), ui_sync_chip(), ui_transfer_chip(), CopyProgress (+4 more)
...
Cohesion: 0.31
Nodes (4): App, Context, Into, String
...
Cohesion: 0.40
Nodes (3): LocalBackend, max_delete_guard_aborts_mass_deletion(), prune_count_keeps_newest_n()

### Community 128 - "Community 128"
Cohesion: 0.70
Nodes (4): SyncJob, run_cmd(), run_one(), log()
...
## Knowledge Gaps
- **607 isolated node(s):** `Arc`, `Result`, `Self`, `Backend`, `Scheme` (+602 more)
...
- **Why does `is_local_style()` connect `Community 80` to `Community 33`, `Community 72`, `Community 10`, `Community 75`, `Community 111`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `cache_remote()` connect `Community 70` to `Community 72`, `Community 62`, `Community 23`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `download_to_temp()` connect `Community 59` to `Community 33`, `Community 27`, `Community 62`?**
