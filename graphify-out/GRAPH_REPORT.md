...
## Summary
- 3021 nodes · 5957 edges · 201 communities (190 shown, 11 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 351 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b2c6cff`
...
Cohesion: 0.06
Nodes (75): Connection, endpoint_addr(), fs_request_label(), fs_response_summary(), handle_fs_stream(), iroh_direct_session_transfers_files(), normalize_tcp_addr(), PeerBackend (+67 more)
...
Cohesion: 0.06
Nodes (46): b64(), b64_decode(), hex(), hex_decode(), hex_val(), hmac_proof(), public_fingerprint(), random_hex_token() (+38 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (74): AnalyticsScan, AppErrorEntry, BisyncCtx, ClipKey, CopyHandle, CopyMode, CopyMsg, App (+66 more)
...
Cohesion: 0.15
Nodes (16): App, export_summary(), selected_direct_label(), selected_room_label(), share_value_field(), upsert_room_member(), Context, PeerOpenTarget (+8 more)
...
Cohesion: 0.21
Nodes (23): LocalBackend, Arc, AtomicBool, BackendHandle, HashSet, Option, PathBuf, Receiver (+15 more)
...
## Knowledge Gaps
- **580 isolated node(s):** `Arc`, `Result`, `Self`, `Backend`, `Scheme` (+575 more)
...
- **Why does `is_local_style()` connect `Community 72` to `Community 67`, `Community 100`, `Community 5`, `Community 12`, `Community 23`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `min_to_hm()` connect `Community 7` to `Community 100`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
